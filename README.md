...
- ️**Image Pick Orientation Issue Fix:** Fixed issue with wrong orientation with picked images with both single and multiple flow.
...
commonMain.dependencies {
  implementation("network.chaintech:cmpfilepicker:1.1.4")
}
```
